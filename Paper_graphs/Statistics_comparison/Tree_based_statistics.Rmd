...
load("/home/julie/Documents/Paper_codes/CUKPAP_EXPERIMENTS/Statistics_comparison/R_files/TreeSynthStat_trueX_fakeY_tables_perfx10.R")
```
...
graph_power_fdp <- ggplot(df_power_fdp, aes(x=fdp, y=power, color = KO)) + 
   ...
   scale_shape_manual(values = c(17,19,9,15)) +  # Adjust the shape values according to your preference
   geom_ribbon(aes(ymin = power - std,ymax = power + std, group = KO, fill = KO), alpha = 0.15, colour = NA) +
