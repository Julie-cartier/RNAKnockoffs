...
graph_power_fdp <- ggplot(df_power_fdp, aes(x=fdp, y=power, color = KO)) + 
   ...
   scale_shape_manual(values = c(7, 15, 17, 18)) +  # Adjust the shape values according to your preference
   geom_ribbon(aes(ymin = power - std, ymax = power + std, group = KO, fill = KO), alpha = 0.15, colour = NA) +
...
ggsave(file = "/home/julie/Documents/Paper_codes/Paper_graphs/Statistics_comparison/Figures/Figure_3.png", height = 10, width = 14)
```
...
ggsave(file = "/home/julie/Documents/Paper_codes/Paper_graphs/Statistics_comparison/Figures/SM_figure_16.png", height = 10, width = 14)
```
...
ggsave(file = "/home/julie/Documents/Paper_codes/Paper_graphs/Statistics_comparison/Figures/Figure_14.png", height = 10, width = 14)
```
