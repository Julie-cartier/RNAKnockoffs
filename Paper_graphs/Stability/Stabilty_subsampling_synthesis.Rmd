...
for (rep in 1:y.rep){
  ...
  load(str_glue("/home/julie/Documents/Paper_codes/CUKPAP_EXPERIMENTS/Stability/R_files/y_rep/table.selected_genes_cv_Vanilla_",rep,".R"))
  load(str_glue("/home/julie/Documents/Paper_codes/CUKPAP_EXPERIMENTS/Stability/R_files/y_rep/table.selected_genes_cv_KOPI_",rep,".R"))
  load(str_glue("/home/julie/Documents/Paper_codes/CUKPAP_EXPERIMENTS/Stability/R_files/y_rep/table_selected_genes_LPLR_",rep,".R"))
  load(str_glue("/home/julie/Documents/Paper_codes/CUKPAP_EXPERIMENTS/Stability/R_files/y_rep/table_selected_genes_LPLR_oracle_",rep,".R"))
...
hist.genes <- ggplot(df.genes, aes(x = freq, fill = status)) +
 ...
 legend.title = element_text(size = 20)  # Format du titre de la légende
  ) +
  scale_fill_manual(
...
graph_LPLR <- ggarrange(hist.genes, hist.genes.oracle, ncol = 2, labels = c("(a) ", "(b) "), common.legend = FALSE, font.label = list(size = 12)) 


graph_KO <- ggarrange(hist_0.2, hist_0.5, ncol = 2, labels = c("(c) ", "(d) "), common.legend = FALSE, font.label = list(size = 12)) 



graph_KOPI <- ggarrange(hist_KOPI_0.2, hist_KOPI_0.5, ncol = 2, labels = c("(e) ", "(f) "), common.legend = FALSE, font.label = list(size = 12)) 
...
ggsave(file = "/home/julie/Documents/Paper_codes/Paper_graphs/Stability/Figures/Figure_4.png", plot = combined_graph, height = 20, width = 17)
