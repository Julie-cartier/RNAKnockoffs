...
load("/media/julie/T5 EVO/Data_cluster/Breast_cancer_data/KO_BC_bank.R")
...
tic()
table.selected.genes.BC.er <- KOPI_selection(X_BC, y_BC.er, list.KO.BC, KO_stats = KO_stats_BC, alpha = 0.5)
toc()
...
save(table.selected.genes.BC.er, file = "/home/julie/Documents/Paper_codes/Selection_with_true_y/R_files/alpha_0_5/BC_er_selected_genes.R")
...
tic()
table.selected.genes.BC.hr2 <- KOPI_selection(X_BC, y_BC.hr2, list.KO.BC, KO_stats = KO_stats_BC_hr2, alpha = 0.5)
toc()
...
save(table.selected.genes.BC.hr2, file = "/home/julie/Documents/Paper_codes/Selection_with_true_y/R_files/alpha_0_5/BC_hR2_selected_genes.R")
...
tic()
table.selected.genes.BC.pgr <- KOPI_selection(X_BC, y_BC.pgr, list.KO.BC, KO_stats = KO_stats_BC_pgr, alpha = 0.5)
toc()

save(table.selected.genes.BC.pgr, file = "/home/julie/Documents/Paper_codes/Selection_with_true_y/R_files/alpha_0_5/BC_pgr_selected_genes.R")
...
tic()
table.selected.genes.AEGIS <- KOPI_selection(X_AEGIS, y_AEGIS, list.KO.AEGIS, alpha = 0.5)
toc()


save(table.selected.genes.AEGIS, list.KO.AEGIS, file = "/home/julie/Documents/Paper_codes/Selection_with_true_y/R_files/alpha_0_5/AEGIS_selected_genes.R")
...
## get data for the CRUKPAP cohort ##
...
# Perform variable selection with KOPI for cancer status classification
tic()
table.selected.genes.CRUKPAP <- KOPI_selection(X_CRUKPAP, y_CRUKPAP, list_X_k_100, alpha = 0.5)
toc()


save(table.selected.genes.CRUKPAP, file = "/home/julie/Documents/Paper_codes/Selection_with_true_y/R_files/alpha_0_5/CRUKPAP_selected_genes.R")
