...
RNA.data <- load("/home/julie/mount/CBIO/cluster/CBIO/data1/jcartier/data/Breast_cancer/BC_data.R")
X_real = X_BC
...
save(split_vec, file = str_glue("/media/julie/T5 EVO/Data_cluster/KO_bank_CV_sets_BC/CV_indices/CV_",i,".RData")) # save the indices (for comparison with other methods)
for (j in 1:10){
  ...
  save(list_KO_cv_100, file = str_glue("/media/julie/T5 EVO/Data_cluster/KO_bank_CV_sets_BC/CV_",i,"_fold_",j,"_X_k_100.RData")) # save into different files
  }
